...
const ImageTile: React.FC<ImageTileProps> = ({ imageUrl, setAvatar }) => {
  return (
    <TouchableWithoutFeedback onPress={() => setAvatar(imageUrl)}>
...
export const ImageChooser: React.FC<ImageChooserProps> = ({ imageSet, imageUrl, setAvatar }) => {
  const [modalVisible, setModalVisible] = useState(false);

  const availableImages = Object.values(ImageSets[imageSet]);
